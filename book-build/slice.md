...
That gap has a specific origin, not a generic one. In 2016 the U.S. Supreme Court decided *Gobeille v. Liberty Mutual Insurance Co.*, 6–2, holding that ERISA preempts a state law requiring health plans — including self-insured employer plans — to report claims data into a state's all-payer claims database. Vermont could not, after that ruling, legally compel every private payer into its data and payment infrastructure. That structural limit became concrete on January 1, 2023, when Blue Cross Blue Shield of Vermont — the state's largest insurer — declined to renew its OneCare contract, removing roughly 93,000 enrollees, about a third of OneCare's total enrollment, in a single step. Blue Cross cited inadequate contractual protection for its members' claims data under OneCare's plan to subcontract analytics to UVM Health Network (a competitor), and no evidence among its own members of progress on health outcomes or cost of care.

::: {custom-style="CalloutWorked"}
**WORKED EXAMPLE — What the documented exit actually looked like**

Blue Cross Blue Shield of Vermont covered roughly 93,000 OneCare enrollees going into 2022 — about a third of the total. Rather than a hospital declining to join for revenue reasons, the exit came from the payer side: Blue Cross's stated objections were data-protection terms in OneCare's plan to subcontract analytics to a competitor (UVM Health Network) and a lack of evidence, among its own members, of improved outcomes or cost. The exit took effect January 1, 2023, removing that population from OneCare's total-cost-of-care management in a single step — the kind of exit *Gobeille v. Liberty Mutual* made a private payer free to make.
:::
...
OneCare operated without this at the maturity real-time risk management requires. The evidence is documented from two directions rather than one invented statistic: OneCare's own staff told Green Mountain Care Board regulators, in a budget presentation, that its data analytics system was not as effective as newer software UVM Health Network was in the process of adopting. Separately, the state auditor's office found that Vermonters attributed to OneCare visited the emergency department at a rate roughly 36% higher than peer ACOs nationally and had about 18% fewer primary care visits — the utilization signature of a population managed reactively rather than proactively. (A precise day-count for OneCare's own internal claims lag is not independently documented in the public record.) This is the "Managing Blind" failure mode: assuming downside financial risk under a Total Cost of Care model without the analytics to track total cost of care in real time. The result is unexpected, unexplainable financial losses — not because the model is wrong, but because the organization cannot see what it is supposed to be managing.
...
Pattern: A payment reform program launches without mandatory policy architecture requiring all relevant payers to participate. Early warning signals: voluntary participation below 80%; persistent non-participation by highest-cost payers or providers; contract redesigns driven by adverse selection rather than clinical results. Vermont evidence: OneCare Vermont, where a 2016 federal ruling (*Gobeille v. Liberty Mutual*) limited the state's ability to compel every payer, and Blue Cross Blue Shield of Vermont exited in 2023 as a result. Correction: Act 68's mandatory RBP and global budgets close the hospital-side version of this gap. Irreversibility threshold: Over roughly a decade, the voluntary architecture had normalized — participants had built business models around the option to stay out or leave, which made the eventual transition to mandatory reform more disruptive than it would have been at the outset.
