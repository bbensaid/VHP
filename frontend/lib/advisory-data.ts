...
export const ADVISORY_SERVICES: AdvisoryService[] = [
  // ── 1. STRATEGIC CONSULTING ──────────────────────────────────────────────
  {
    ...
    shortDescription:
      "Partner with C-suite executives to design resilient operational frameworks across all five pillars — from regulatory strategy and value-based care models to clinical transformation and operational execution — each held to the Equity Imperative.",
    icon: "🏛️",
    ...
    processSteps: [
      { stepNumber: 1, title: "Discovery & Baseline Audit", description: "Assess current state across all five pillars — policy exposure, financial performance, technology maturity, clinical outcomes, and operational readiness — plus an Equity Imperative gap check.", duration: "2–3 weeks" },
