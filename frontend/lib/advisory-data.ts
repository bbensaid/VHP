...
export const ADVISORY_SERVICES: AdvisoryService[] = [
  // ── 1. STRATEGIC CONSULTING ──────────────────────────────────────────────
  {
    ...
    shortDescription:
      "Partner with C-suite executives to design resilient operational frameworks across all five pillars — from regulatory strategy and value-based care models to clinical transformation and health equity programs.",
    icon: "🏛️",
    ...
    processSteps: [
      { stepNumber: 1, title: "Discovery & Baseline Audit", description: "Assess current state across all five pillars — policy exposure, financial performance, technology maturity, clinical outcomes, and equity gaps.", duration: "2–3 weeks" },
    ...
    tiers: [
      ...
      { name: "Full Engagement", price: "$120,000+", description: "Comprehensive multi-pillar strategy engagement over 3–6 months.", includes: ["All 5-pillar assessment", "Board-ready strategic plan", "Implementation roadmap", "3 quarterly check-ins"], highlight: true },
  ...
  // ── 8. TRAINING & EXECUTIVE EDUCATION ────────────────────────────────────
  {
    ...
    shortDescription:
      "Healthcare-specific professional development that bridges the gap between policy awareness and operational execution — from project management fundamentals to domain-area expertise across all 5 pillars.",
    icon: "🎓",
    ...
    processSteps: [
      ...
      { stepNumber: 2, title: "Curriculum Design", description: "Build customized curriculum using HTR's 5-pillar framework, practitioner-led content, and real case studies.", duration: "2–3 weeks" },
