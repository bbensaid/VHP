    ...
    <div className="bg-white min-h-screen pb-20">
      ...
      <div className="bg-teal-600 text-white py-16 border-b border-teal-700">
        <div className="container mx-auto px-4 md:px-8 max-w-4xl text-center">
          ...
          <h1 className="ty-h1 font-black mb-4 tracking-tight">{title}</h1>
          <p className="ty-hero text-teal-100 max-w-2xl mx-auto leading-relaxed">{subtitle}</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-8 mt-12 max-w-6xl">
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="flex-1 space-y-10">
            ...
            {/* What you get */}
            <div>
              <h2 className="ty-h3 font-black text-slate-900 mb-5">What This Gives You</h2>
                ...
                {features.map((f, i) => (
                  <div key={i} className="flex items-start gap-4 p-4 rounded-xl border border-slate-100 bg-slate-50">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 ty-body leading-relaxed">{f.description}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {/* How it works */}
            <div>
              <h2 className="ty-h3 font-black text-slate-900 mb-5">How It Works</h2>
              <div className="space-y-4">
                {steps.map((s) => (
                  <div key={s.step} className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 ty-body leading-relaxed">{s.description}</p>
                    </div>
                  </div>
                ))}
              </div>
