...
export default function CollapsibleSidebar({
  ...
  headerContent,
  hideLabel = "Hide",
  stickyTop = "9rem", // Synchronized with AppShell's sidebarTop
  ...
  return (
    <div
      ...
      className={`
        bg-white transition-all duration-300 ease-in-out flex-shrink-0 z-40
        border-slate-200 sticky flex flex-col overflow-hidden
        ${isLeft ? "border-r" : "border-l"}
        ${effectiveOpen ? "w-80 opacity-100" : "w-0 opacity-0 border-none"}
      `}
      style={{ 
        top: stickyTop, 
