          ...
          >
            ...
            >
              ...
              <div className="mb-4">
                ...
                <h3 className="ty-h3 font-black text-slate-900 dark:text-slate-100">
                  {selectedItem.label}
                </h3>
              </div>
              ...
              <div className="bg-slate-50 dark:bg-slate-800 rounded-lg p-4 border border-slate-100 dark:border-slate-700 ty-body text-slate-600 dark:text-slate-300 leading-relaxed">
