...
export default function OnboardingModal() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg relative overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
        ...
        <div className="p-8">
          ...
          {step === "welcome" && (
            <div className="text-center">
              ...
              <h2 className="text-2xl font-black text-slate-900 mb-3">Welcome to HTR</h2>
              ...
              <div className="grid grid-cols-2 gap-3 mb-6 text-left">
                {[
                  ...
                  { icon: ChartBarIcon, label: "Research Lab", desc: "19 analytical tools" },
          ...
          {step === "role" && (
            <div>
              ...
              <p className="text-sm text-slate-400 mb-5">We&apos;ll tailor your experience to your role.</p>
              <div className="grid grid-cols-2 gap-2">
                {ROLES.map((role) => (
                  ...
                  >
                    ...
                    <span className={`text-sm font-semibold ${selectedRole === role.id ? "text-indigo-700" : "text-slate-700"}`}>
                      {role.label}
                    </span>
                  </button>
                ))}
          ...
          {step === "pillars" && (
            <div>
              <h2 className="text-xl font-black text-slate-900 mb-1">Choose your focus areas</h2>
              <p className="text-sm text-slate-400 mb-5">Select one or more pillars to personalize your feed.</p>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <span className={`text-sm font-bold ${selected ? "text-indigo-700" : "text-slate-800"}`}>
                          {pillar.label}
                        </span>
                        <span className="text-xs text-slate-400 ml-2">{pillar.desc}</span>
                      </div>
                      {selected && (
              ...
              <div className="space-y-2 text-left mb-6">
                {[
                  ...
                  <Link
                    ...
                    href={item.href}
                    onClick={complete}
                    className="flex items-center justify-between px-4 py-3 bg-slate-50 hover:bg-indigo-50 rounded-xl group transition-colors"
                  >
                    <div>
          ...
          <div className="flex items-center justify-between mt-2">
            <div className="flex gap-1">
              {STEPS.map((s, i) => (
                <span
                  key={s}
                  className={`w-2 h-2 rounded-full transition-colors ${i <= stepIndex ? "bg-indigo-500" : "bg-slate-200"}`}
                />
              ))}
            </div>
