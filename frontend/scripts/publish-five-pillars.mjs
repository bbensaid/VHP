#!/usr/bin/env node
// Report (and optionally set) the publish state of the Five Pillars course,
// its tracks and its lessons in Supabase.
//
//   node scripts/publish-five-pillars.mjs            # report only
//   node scripts/publish-five-pillars.mjs --publish  # publish course + tracks + lessons
//
...
const SLUG = 'five-pillars-one-imperative';
...
if (!doPublish) {
  ...
  console.log(blocked
    ? '\nRESULT: /academy/tracks/five-pillars-one-imperative will 404 or render empty.\n' +
