// scripts/seed-health-equity-analytics-course.mjs
//
// Seeds ONLY the "Health Equity Analytics" course
// (frontend/content/course_health_equity_analytics.json) into Supabase.
//
...
//
//   cd frontend && node scripts/seed-health-equity-analytics-course.mjs
//
...
const course = JSON.parse(
  readFileSync(join(__dir, "../content/course_health_equity_analytics.json"), "utf8"),
);
