    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="bg-slate-50 border-b border-slate-200 py-16">
        <div className="container mx-auto px-4 md:px-8 text-center max-w-3xl">
          <h1 className="ty-h1 font-black text-slate-900 mb-6">
                    ...
                    {groupedTerms[letter].map((item) => (
                      ...
                      >
                        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-2">
                          <h3 className="ty-h3 font-bold text-slate-900">{item.term}</h3>
                        ...
                        <p className="text-slate-600 ty-hero leading-relaxed">{item.description}</p>
                      </div>
                    ))}
                  </div>
                </div>
