        ...
        <div className="grid md:grid-cols-2 gap-10 mb-16">
          ...
          <div className="space-y-5">
            <div className="bg-teal-50 border border-teal-200 rounded-xl p-6">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">Estimated annual waste in US healthcare attributable to administrative complexity and billing inefficiency, per JAMA estimates. Revenue cycle dysfunction is the single largest non-clinical cost driver in American healthcare.</p>
            </div>
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">Composite of clean claim rate, denial rate, and days in AR across the state's major health systems. Weight: 0.05 in the HTR Performance Index.</p>
            </div>
          </div>
        </div>
