...
export const metadata = {
  title: "Workforce & Human Capital | HTR Operations",
  description: "Healthcare workforce strategy — staffing models, clinician retention, labor economics, care team design, and the human capital dimensions of health system transformation.",
};
