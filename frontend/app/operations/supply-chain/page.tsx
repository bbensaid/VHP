        ...
        <div className="grid md:grid-cols-2 gap-10 mb-16">
          ...
          <div className="space-y-5">
            <div className="bg-teal-50 border border-teal-200 rounded-xl p-6">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">The pandemic exposed what health system operations experts had long known: supply chain fragility is not an efficiency problem — it is a patient safety and care continuity problem. Transformation strategies that expand care delivery footprints without assessing supply chain capacity are building on an untested foundation.</p>
            </div>
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              <p className="text-[11px] font-black uppercase tracking-widest text-slate-500 mb-2">The Expansion Risk</p>
              <p className="text-sm text-slate-600 leading-relaxed">Hospital-at-Home, telehealth expansion, and community health worker programs all require supply chain extensions beyond traditional hospital walls. HTR analyzes whether existing logistics infrastructure can support the expanded footprint of proposed care models.</p>
            </div>
          </div>
        </div>
