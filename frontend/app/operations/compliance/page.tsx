...
export const metadata = {
  title: "Quality, Compliance & Risk | HTR Operations",
  description: "Healthcare quality program management, regulatory compliance, CMS Conditions of Participation, accreditation strategy, and enterprise risk management for health organizations.",
};
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-16">
          ...
          <div className="space-y-5">
            <div className="bg-teal-50 border border-teal-200 rounded-xl p-6">
              ...
              <p className="ty-body text-slate-600 leading-relaxed">The rules are set by Policy. The legal exposure is analyzed by Risk. But whether the organization has the staff, systems, and culture to actually comply — day in, day out, at scale — is an Operations question.</p>
            </div>
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              ...
              <p className="ty-body text-slate-600 leading-relaxed">Every new care model, payment arrangement, and technology deployment carries a compliance surface. Organizations with weak compliance infrastructure cannot safely absorb rapid change — creating an operational ceiling on transformation speed.</p>
            </div>
          </div>
        </div>
