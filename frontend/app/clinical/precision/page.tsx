    ...
    <div className="max-w-7xl mx-auto px-6 pt-0 pb-12">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-8 mb-10">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-lg md:text-xl font-bold text-slate-900">Genomic Assay Comparison — Breast Cancer</h2>
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 mb-10">
        <h2 className="text-lg md:text-xl font-bold text-slate-900 mb-2">Precision Medicine Program Imperatives</h2>
