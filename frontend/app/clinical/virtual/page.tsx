    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="mb-12">
        ...
        <p className="text-xl text-slate-600 max-w-3xl">
          Data-driven approaches to improve health outcomes for entire patient populations.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2">
          ...
          <p className="text-lg text-slate-700 leading-relaxed mb-8">
            Deep dive into the analytics and strategies used to manage the health of defined populations. Includes risk stratification methodologies, care gap analysis, and the use of predictive modeling to prevent adverse events. We also look at the intersection of clinical data and social determinants in population management.
          </p>
          ...
          <div className="bg-rose-50 border border-rose-100 rounded-xl p-8">
             ...
             <ul className="space-y-3">
               {['Risk Stratification', 'Care Gap Analysis', 'Predictive Analytics'].map(item => (
