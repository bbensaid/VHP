      ...
      <div className="container mx-auto px-4 md:px-8 max-w-5xl py-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-all">
            ...
            <h3 className="ty-h3 font-bold text-slate-900 mb-3">Revenue Cycle Assessment</h3>
            <p className="text-slate-600 ty-body mb-4">End-to-end review from charge capture through final payment. We map every step where revenue leaks and quantify the dollar impact.</p>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-all">
            <div className="w-12 h-12 bg-emerald-100 text-emerald-700 rounded-lg flex items-center justify-center text-2xl mb-6 border border-emerald-200">🤝</div>
            <h3 className="ty-h3 font-bold text-slate-900 mb-3">Payer Contract Performance</h3>
            <p className="text-slate-600 ty-body mb-4">Are your payer contracts paying what they promised? We analyze actual vs. contracted payments, identify systematic underpayments, and develop renegotiation strategy.</p>
            <ul className="space-y-2 ty-body text-slate-600">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-all">
            <div className="w-12 h-12 bg-emerald-100 text-emerald-700 rounded-lg flex items-center justify-center text-2xl mb-6 border border-emerald-200">📊</div>
            <h3 className="ty-h3 font-bold text-slate-900 mb-3">Cost Structure Analysis</h3>
            <p className="text-slate-600 ty-body mb-4">Department-level cost analysis benchmarked against HFMA Peer Comparison data and CMS cost reports. We identify where you&apos;re overspending relative to peers and why.</p>
            <ul className="space-y-2 ty-body text-slate-600">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-all">
            <div className="w-12 h-12 bg-emerald-100 text-emerald-700 rounded-lg flex items-center justify-center text-2xl mb-6 border border-emerald-200">👥</div>
            <h3 className="ty-h3 font-bold text-slate-900 mb-3">Staffing Efficiency Review</h3>
            <p className="text-slate-600 ty-body mb-4">Healthcare labor is the largest operating cost. We benchmark your staffing ratios, labor mix, and productivity against top-quartile performers to identify sustainable savings.</p>
            <ul className="space-y-2 ty-body text-slate-600">
