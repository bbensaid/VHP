      ...
      <div className="container mx-auto px-4 md:px-8 max-w-5xl py-16">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-3">Evidence-First</h3>
            <p className="text-slate-600 leading-relaxed text-sm">Every recommendation traces to a specific piece of evidence — a CMS rule, a clinical trial, a financial model, a peer-reviewed study. We show our work, and we welcome challenges to our conclusions.</p>
          </div>
          <div className="text-center">
            <div className="text-5xl mb-4">🧑‍⚕️</div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">Practitioner-Led</h3>
            <p className="text-slate-600 leading-relaxed text-sm">HTR advisors have direct operational experience in the domains they consult on — former hospital executives, health economists, clinical informaticists, and policy analysts with government service. Not just researchers.</p>
          </div>
          <div className="text-center">
            <div className="text-5xl mb-4">⚖️</div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">Completely Independent</h3>
            <p className="text-slate-600 leading-relaxed text-sm">We have no vendor relationships, no referral arrangements, no political affiliations, and no preferred products. Our only commercial interest is your engagement fee — which means our only incentive is producing advice that actually works.</p>
          </div>
        </div>
      </div>
              ...
              <div key={stage.stage} className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="p-6 md:p-8 flex-1">
                    ...
                    <p className="text-slate-600 text-sm leading-relaxed mb-4">{stage.desc}</p>
                    <div>
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-5xl py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white border-2 border-fuchsia-200 rounded-xl p-8">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">Principal Advisor</h3>
            <p className="text-slate-600 text-sm leading-relaxed mb-4">Leads every engagement. 15+ years of operational or policy experience in the relevant domain. Named at proposal stage and does not change without client notification and approval.</p>
          ...
          <div className="bg-white border-2 border-slate-200 rounded-xl p-8">
            <div className="text-4xl mb-4">📊</div>
            <h3 className="text-xl font-bold text-slate-900 mb-2">Research Analyst</h3>
            <p className="text-slate-600 text-sm leading-relaxed mb-4">Conducts the day-to-day analysis, literature review, financial modeling, and data work. Typically a specialist in one or two HTR pillars with deep quantitative skills.</p>
            <ul className="space-y-1.5 text-xs text-slate-500">
          ...
          <div className="bg-white border-2 border-slate-200 rounded-xl p-8">
            <div className="text-4xl mb-4">🧠</div>
            <h3 className="text-xl font-bold text-slate-900 mb-2">Domain Expert</h3>
            <p className="text-slate-600 text-sm leading-relaxed mb-4">Called in for specialized input — clinical workflows, regulatory interpretation, financial modeling validation, or equity framework application. Drawn from HTR&apos;s network of former policymakers, clinicians, and economists.</p>
            <ul className="space-y-1.5 text-xs text-slate-500">
