    ...
    <div className="bg-white min-h-screen pb-20">
      ...
      <div className="bg-slate-50 text-slate-900 py-8 border-b border-slate-200">
        <div className="container mx-auto px-4 md:px-8 max-w-5xl">
          ...
          <h1 className="ty-h1 font-bold tracking-tight mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {CAPABILITIES.map((cap) => (
            <div key={cap.title} className="p-8 border border-slate-200 rounded-xl hover:border-rose-400 hover:shadow-lg transition-all bg-white">
              ...
              <h3 className="ty-h3 font-bold text-slate-900 mb-3">{cap.title}</h3>
              <p className="text-slate-600 ty-body mb-4 leading-relaxed">{cap.description}</p>
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-4xl mt-8 text-center">
        <h2 className="ty-h1 font-bold text-slate-900 mb-4">Commission Your Research</h2>
        <p className="ty-hero text-slate-600 mb-8">
