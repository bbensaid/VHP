...
export const metadata = {
  ...
  description:
    "World-class healthcare advisory services across all 5 pillars — Policy, Technology, Economics, Clinical, and Operations — each held to the Equity Imperative. Strategic consulting, IT project advisory, financial auditing, regulatory counsel, and executive training.",
};
    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-center">
            {ADVISORY_STATS.map((stat) => (
              <div key={stat.label}>
                <div className="ty-h1 font-black text-fuchsia-300 mb-1">{stat.value}</div>
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-6xl py-20">
        <div className="text-center mb-14">
          ...
          <h2 className="ty-h1 font-black text-slate-900 mb-4">Eight Practice Areas. One Integrated Framework.</h2>
          <p className="ty-hero text-slate-500 max-w-3xl mx-auto">
            Every HTR Advisory engagement draws from the full 5-pillar framework, held to the Equity Imperative — because healthcare problems never respect disciplinary boundaries.
          </p>
        </div>
            ...
            <div className="max-w-xl">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  { label: "Research Lab", desc: "Full access to all 24 tools" },
                ].map((item) => (
      ...
      <div className="bg-slate-50 py-20 border-y border-slate-200">
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          <div className="text-center mb-14">
            <h2 className="ty-h1 font-black text-slate-900 mb-4">The HTR 5-Pillar Advantage</h2>
            <p className="ty-hero text-slate-500 max-w-3xl mx-auto">
              Every recommendation we make is stress-tested against all five pillars and the Equity Imperative. Siloed expertise creates blind spots. We eliminate them.
            </p>
          </div>
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-6xl py-20">
        <div className="text-center mb-14">
          <h2 className="ty-h1 font-black text-slate-900 mb-4">How We Work</h2>
      ...
      <div className="bg-indigo-700 text-white py-20">
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          <div className="text-center mb-14">
            <h2 className="ty-h1 font-black mb-4">Types of Clients We Serve</h2>
            <p className="ty-hero text-indigo-100 max-w-2xl mx-auto">
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-6xl py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-linear-to-b from-fuchsia-50 to-white border-2 border-fuchsia-200 rounded-xl p-8">
            ...
            <h3 className="ty-h3 font-bold text-slate-900 mb-3">Embedded Intelligence</h3>
          ...
          <div className="bg-linear-to-b from-fuchsia-50 to-white border-2 border-fuchsia-200 rounded-xl p-8">
            ...
            <h3 className="ty-h3 font-bold text-slate-900 mb-3">Non-Partisan Framework</h3>
            <p className="text-slate-600 ty-body leading-relaxed">
          ...
          <div className="bg-linear-to-b from-fuchsia-50 to-white border-2 border-fuchsia-200 rounded-xl p-8">
            <div className="text-4xl mb-4">⚡</div>
            <h3 className="ty-h3 font-bold text-slate-900 mb-3">Speed to Insight</h3>
            <p className="text-slate-600 ty-body leading-relaxed">
      ...
      <div className="bg-linear-to-r from-fuchsia-700 via-indigo-700 to-slate-900 py-24">
        <div className="container mx-auto px-4 md:px-8 max-w-4xl text-center text-white">
          <h2 className="ty-h1 font-black mb-6">Ready to Engage?</h2>
          <p className="ty-hero text-fuchsia-200 mb-10 max-w-2xl mx-auto leading-relaxed">
