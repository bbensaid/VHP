      ...
      <div className="container mx-auto px-4 md:px-8 max-w-5xl py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-all">
            ...
            <p className="text-slate-600 ty-body mb-4">Governance frameworks for clinical AI tools, vendor evaluation, bias monitoring, and responsible deployment across all five HTR pillar dimensions.</p>
            <ul className="space-y-1.5 text-xs text-slate-600 font-medium">
