...
export const metadata = {
  title: "Public Health Mandates | HTR Policy",
  description: "Tracking and analysis of federal and state public health mandates, vaccine policy, emergency declarations, and compliance obligations for health organizations.",
};
    ...
    <div className="max-w-7xl mx-auto px-6 pt-0 pb-12">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-8 mb-10">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="ty-h3 font-bold text-slate-900">Active Federal Healthcare Mandates</h2>
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 mb-10">
        <h2 className="ty-h3 font-bold text-slate-900 mb-2">Compliance Readiness Framework</h2>
