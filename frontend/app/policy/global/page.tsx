    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="mb-12">
        ...
        <p className="text-xl text-slate-600 max-w-3xl">
          Benchmarking against international health systems and OECD data.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2">
          ...
          <p className="text-lg text-slate-700 leading-relaxed mb-8">
            Compares US health policy performance against international benchmarks. We analyze OECD data on cost, access, and outcomes to identify best practices from other health systems. Topics include drug pricing models, universal coverage strategies, and health technology assessment frameworks.
          </p>
          ...
          <div className="bg-orange-50 border border-orange-100 rounded-xl p-8">
             ...
             <ul className="space-y-3">
               {['International Health Systems', 'OECD Benchmark Analysis', 'Cross-Border Health Data'].map(item => (
