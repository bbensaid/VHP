    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="mb-12">
        ...
        <p className="text-xl text-slate-600 max-w-3xl">
          Modeling the economic impact and implementation roadmap for new policies.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2">
          ...
          <p className="text-lg text-slate-700 leading-relaxed mb-8">
            Provides forward-looking analysis on proposed healthcare policies. We model the potential economic impact, assess stakeholder positions, and develop implementation roadmaps. This section helps organizations anticipate policy shifts and prepare strategic responses.
          </p>
          ...
          <div className="bg-orange-50 border border-orange-100 rounded-xl p-8">
             ...
             <ul className="space-y-3">
               {['Economic Impact Modeling', 'Stakeholder Analysis', 'Implementation Roadmaps'].map(item => (
