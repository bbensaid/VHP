...
export default async function CoursesPage() {
  ...
  const getFilterStyle = (filter: string, index: number) => {
    ...
    switch(filter) {
        case "Policy Pillar": return "bg-white text-card-policy border-card-policy/30 hover:border-card-policy hover:bg-orange-50";
        case "Economics Pillar": return "bg-white text-card-economics border-card-economics/30 hover:border-card-economics hover:bg-emerald-50";
        case "Technology Pillar": return "bg-white text-card-tech border-card-tech/30 hover:border-card-tech hover:bg-indigo-50";
        default: return "bg-white text-gray-600 border-gray-300 hover:border-gray-400 hover:bg-gray-50";
    }
  };
