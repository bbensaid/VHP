    ...
    <ConnectEarlyAccess
      ...
      features={[
        ...
        },
        {
          ...
          description: 'Choose which of the Five Pillars (Policy, Technology, Economics, Clinical, Operations) or the Equity Imperative are relevant to your organization. You only receive alerts for opportunities in your selected areas.',
        },
        {
          icon: '🏥',
