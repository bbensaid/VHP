  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="max-w-md text-center bg-white border border-slate-200 rounded-2xl p-12 shadow-sm">
        ...
        <h1 className="text-2xl font-black text-slate-900 mb-2">AI Analyst unavailable</h1>
        <p className="text-slate-500 text-sm mb-6">The AI Analyst is temporarily unavailable. Our team has been notified.</p>
