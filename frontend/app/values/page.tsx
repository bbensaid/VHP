...
const values = [
  ...
  },
  {
    ...
    body: "A policy that is permissible but economically unsustainable is not a solution. A technology that is possible but operationally undeliverable is not progress. We test every insight across all five pillars, and against the Equity Imperative, before it reaches you.",
    detail: "This is the core discipline that separates HTR from conventional health policy or business analysis. A recommendation that optimizes for one dimension — cost, or quality, or equity — while creating new failures in another is not a recommendation we will publish. Every insight must survive interrogation across Policy, Technology, Economics, Clinical, and Operations — and must then pass the Equity Imperative — before it leaves our desk.",
    standard: "Five-pillar stress test, held to the Equity Imperative, on every analysis",
  },
  {
    icon: HeartIcon,
    color: "text-rose-600",
  ...
  },
  {
    ...
    body: "Policymakers, economists, clinicians, technologists, equity advocates, and operations executives do not naturally speak the same language. HTR is the translation layer — and we hold every piece of intelligence we publish to the five-pillar, one-imperative standard.",
    detail: "Our editorial structure is explicitly cross-functional. Before any analysis is published, it is reviewed by analysts from at least two adjacent disciplines. A technology piece is reviewed by our Economics, Clinical, and Operations leads. A policy analysis passes through our Operations, Technology, and Economics desks, and is checked against the Equity Imperative. This is not a formality — it is the mechanism by which we catch the blind spots that siloed thinking invariably produces.",
