  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
      ...
      <div className="p-6 space-y-6">
        ...
        {step === 0 && (
          <>
            <h2 className="ty-h3 font-black text-slate-900">About You</h2>
        ...
        {step === 1 && (
          <>
            <h2 className="ty-h3 font-black text-slate-900">Transformation Readiness</h2>
        ...
        {step === 2 && (
          <>
            <h2 className="ty-h3 font-black text-slate-900">Technology & Digital Health</h2>
        ...
        {step === 3 && (
          <>
            <h2 className="ty-h3 font-black text-slate-900">Policy Priorities</h2>
