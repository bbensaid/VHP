      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {COHORTS.map(c => (
          <div key={c.id} className={`rounded-xl border ${c.accentBorder} ${c.accentBg} p-5`}>
            ...
            <p className="text-slate-600 ty-body leading-relaxed mb-3">{c.description}</p>
          ...
          <div key={s.id} className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
            <div className="flex flex-col md:flex-row md:items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-600 ty-body leading-relaxed mb-2">{s.description}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {TOOLKITS.map(t => (
          <div key={t.id} className={`rounded-xl border ${t.accentBorder} ${t.accentBg} p-5`}>
            ...
            <p className="text-slate-600 ty-body leading-relaxed mb-3">{t.description}</p>
            <Link
          ...
          <div key={g.id} className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
            <div className="flex flex-col md:flex-row md:items-start gap-3">
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 ty-body text-slate-600 mb-3">
                  <div>
          ...
          <div key={f.id} className={`rounded-2xl border ${f.accentBorder} ${f.accentBg} p-6`}>
            <div className="flex flex-col md:flex-row md:items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-600 ty-body leading-relaxed mb-3">{f.description}</p>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white border-2 border-teal-200 rounded-2xl p-6">
        ...
        <p className="text-slate-600 ty-body mb-4">
