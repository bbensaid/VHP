    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-slate-950 text-white">
        <div className="max-w-5xl mx-auto px-6 py-20">
          ...
          <h1 className="ty-h1-xl font-black tracking-tight mb-5 leading-tight">
            ...
            {[
              ...
              <div key={item.title} className="bg-white border border-slate-200 rounded-xl p-5 flex gap-4">
                ...
                <div>
                  ...
                  <div className="ty-body text-slate-600 leading-relaxed">{item.body}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            {[
              ...
              <div key={s.step} className="bg-white border border-slate-200 rounded-2xl p-6">
                ...
                <p className="text-slate-600 ty-body leading-relaxed">{s.body}</p>
              </div>
            ))}
          </div>
                  ...
                  <div className="p-6">
                    <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <h3 className="ty-h3 font-black text-slate-900">{uc.name}</h3>
                        <div className="text-sm font-bold text-slate-500 mb-3">{uc.subtitle}</div>
                        <p className="text-slate-600 ty-body leading-relaxed mb-4">{uc.description}</p>
