...
function OverviewTab() {
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-br from-violet-50 to-indigo-50 border border-violet-100 rounded-2xl p-8">
        <div className="max-w-3xl">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <div className="text-xs font-black uppercase tracking-widest text-violet-600">HTR Simulator</div>
              <div className="text-xl font-black text-slate-900">Health Transformation Roadmap Simulator</div>
            </div>
          </div>
          <p className="text-slate-700 text-lg leading-relaxed mb-4">
            The HTR Simulator is a decision-support platform for healthcare policymakers, system leaders, and
            analysts. It models the downstream consequences of transformation decisions — across policy, technology,
            financial, equity, and clinical dimensions — before those decisions are implemented.
          </p>
          <p className="text-slate-600 leading-relaxed">
            Rather than relying on intuition or single-variable analysis, the simulator provides a structured,
            multi-pillar scoring framework that surfaces tradeoffs, highlights risks, and estimates the combined
            impact of any combination of reforms on a healthcare system.
          </p>
        </div>
      </div>
      ...
      {/* What it does */}
      <div>
        <h2 className="text-xl font-black text-slate-900 mb-4">What the Simulator Does</h2>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        <h2 className="text-xl font-black text-slate-900 mb-4">Who It&apos;s For</h2>
        <div className="grid md:grid-cols-3 gap-4">
          {[
            {
              audience: "Policymakers & Legislators",
              description: "Understand the full downstream impact of legislation before it passes — financial, clinical, and equity consequences made visible.",
            },
            {
              audience: "Health System Executives",
              description: "Model which transformation strategies best preserve institutional viability while advancing population health goals.",
            },
            {
              audience: "Analysts & Consultants",
              description: "Rapidly prototype scenarios, generate structured outputs, and communicate complex tradeoffs to diverse stakeholders.",
            },
          ].map(item => (
            <div key={item.audience} className="bg-slate-50 rounded-xl p-4 border border-slate-100">
              <div className="font-bold text-slate-900 mb-2 text-sm">{item.audience}</div>
      ...
      {/* CTA */}
      <div className="bg-violet-900 rounded-2xl p-6 text-white flex flex-col md:flex-row items-center justify-between gap-4">
        <div>
          <div className="font-black text-lg mb-1">Ready to model a transformation?</div>
          <div className="text-violet-300 text-sm">Start with the Vermont Act 167 use case — our most complete simulation to date.</div>
        </div>
        <Link
          href="/vermont-act-167/simulator"
          className="inline-flex items-center gap-2 bg-white text-violet-900 font-black text-sm px-6 py-3 rounded-xl hover:bg-violet-50 transition-colors shrink-0"
        >
...
function FrameworkTab() {
  return (
    <div className="space-y-8">
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        <h2 className="text-xl font-black text-slate-900 mb-2">The 5-Pillar Scoring Framework</h2>
        <p className="text-slate-600 leading-relaxed">
          Every transformation scenario is evaluated across five independent pillars. Each pillar receives a
          score from 0–100 based on the recommendations selected, their estimated implementation complexity,
          and their expected impact on that dimension. Pillar scores combine into an overall transformation
          readiness score.
        </p>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        <h2 className="text-lg font-black text-slate-900 mb-4">Score Interpretation</h2>
...
function EngineTab() {
  return (
    <div className="space-y-8">
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        <h2 className="text-xl font-black text-slate-900 mb-2">How the Simulation Engine Works</h2>
        <p className="text-slate-600 leading-relaxed">
          The simulation engine translates a set of selected policy recommendations into quantified
          impact estimates across institutions, geographies, and populations. It operates in three
          stages: recommendation scoring, scenario aggregation, and impact projection.
        </p>
      </div>
      ...
      {/* Data model */}
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        <h2 className="text-lg font-black text-slate-900 mb-4">Data Model</h2>
        <p className="text-slate-600 text-sm leading-relaxed mb-5">
          Each use case is powered by a structured dataset that includes institution profiles, population
          health metrics, financial data, and geographic attributes. Data is sourced from public datasets
          (CMS cost reports, AHA annual surveys, Census Bureau, HIFLD) and supplemented with use-case-specific
          analysis.
        </p>
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3">
          {[
            "Institution profiles (beds, ICU, FTEs, services)",
            "Operating margin and financial trajectory",
            "Emergency department volume and acuity",
            "Population health service area (HSA) data",
            "Geographic access & travel time analysis",
            "Social determinants burden by service area",
            "Workforce composition and vacancy rates",
            "Technology maturity index by institution",
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <ul className="text-sm text-amber-800 space-y-1.5 leading-relaxed">
              ...
              <li>• The engine does not model political feasibility, stakeholder opposition, or execution quality — all of which are critical determinants of real-world outcomes.</li>
...
function UseCasesTab() {
  return (
    <div className="space-y-8">
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        <h2 className="text-xl font-black text-slate-900 mb-2">Simulation Use Cases</h2>
        <p className="text-slate-600 leading-relaxed">
          The HTR Simulator is designed to be applied to any healthcare transformation context. Each use
          case is a fully configured instance of the simulation engine — populated with context-specific
          institutions, recommendations, and data. The generic educational framework lives here; use case
          pages go directly into the simulation.
        </p>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-4">
              ...
              If you are working on a transformation initiative that would benefit from this framework, contact the
              HTR team to discuss onboarding your context as a new use case.
            </p>
            <Link
              href="/advisory-hub"
...
function MethodologyTab() {
  return (
    <div className="space-y-8">
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        <h2 className="text-xl font-black text-slate-900 mb-2">Methodology</h2>
        <p className="text-slate-600 leading-relaxed">
          The HTR Simulator methodology is grounded in structured decision analysis, health policy research,
          and lessons from comparable transformation programs across the United States. This page documents
          the analytical foundations, data sources, and scoring logic.
        </p>
      </div>

      {/* Scoring methodology */}
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        <h2 className="text-lg font-black text-slate-900 mb-4">Recommendation Scoring</h2>
        <p className="text-slate-600 text-sm leading-relaxed mb-5">
          Each recommendation in a use case is scored by domain experts on four dimensions, which combine into
          the pillar-level impact scores shown in the simulator.
        </p>
      ...
      {/* Assumptions */}
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        <h2 className="text-lg font-black text-slate-900 mb-4">Key Assumptions</h2>
        <ul className="space-y-2 text-sm text-slate-600 leading-relaxed">
          <li className="flex gap-2"><span className="text-slate-400 font-bold shrink-0">1.</span>Pillar scores are additive within a scenario unless documented interactions between recommendations create synergies or conflicts.</li>
          <li className="flex gap-2"><span className="text-slate-400 font-bold shrink-0">2.</span>Financial projections assume constant payment rates unless a recommendation specifically alters payment structures.</li>
          <li className="flex gap-2"><span className="text-slate-400 font-bold shrink-0">3.</span>Population access metrics assume current utilization patterns hold unless service reconfiguration is explicitly modeled.</li>
          <li className="flex gap-2"><span className="text-slate-400 font-bold shrink-0">4.</span>Workforce projections do not account for regional labor market conditions or recruitment timelines.</li>
          <li className="flex gap-2"><span className="text-slate-400 font-bold shrink-0">5.</span>Technology readiness scores assume current baseline maturity; they do not forecast organic improvement independent of transformation investment.</li>
        </ul>
      </div>
      ...
      <div className="flex items-start gap-3 bg-blue-50 border border-blue-200 rounded-xl p-4">
        ...
        <div className="text-sm text-blue-800">
          ...
          expert review is completed. Feedback and methodological challenges are welcomed via the Advisory Hub.
        </div>
      </div>
    </div>
  );
...
export default function HTRSimulatorPage() {
  ...
  return (
    <HubPageTemplate
      badgeLabel="Beta · Synthetic Data"
      title="HTR Simulator"
      subtitle="Health Transformation Roadmap Simulator — model the multi-pillar impact of any combination of healthcare transformation decisions before implementation."
      tabs={tabs}
      backLink="/"
      backLabel="Home"
