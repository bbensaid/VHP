    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="mb-12">
        ...
        <p className="text-xl text-slate-600 max-w-3xl">
          Analyzing remote monitoring, virtual care, and digital therapeutics (DTx).
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2">
          ...
          <p className="text-lg text-slate-700 leading-relaxed mb-8">
            Tracks the maturation of the digital health ecosystem. We analyze the efficacy of Digital Therapeutics (DTx), the scalability of Remote Patient Monitoring (RPM) platforms, and the user experience of virtual care interfaces. This section also covers the integration of patient-generated data into the EHR.
          </p>
          ...
          <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-8">
             ...
             <ul className="space-y-3">
               {['Remote Monitoring Platforms', 'Virtual First Care Models', 'Digital Therapeutics (DTx)'].map(item => (
