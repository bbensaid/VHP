    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="mb-12">
        ...
        <p className="text-xl text-slate-600 max-w-3xl">
          Focusing on cybersecurity, interoperability (TEFCA), and patient consent.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2">
          ...
          <p className="text-lg text-slate-700 leading-relaxed mb-8">
            Addresses the critical infrastructure of health data exchange. We examine cybersecurity threats, ransomware resilience, and compliance with HIPAA and HITRUST. A major focus is on the implementation of TEFCA and the Trusted Exchange Framework for nationwide interoperability.
          </p>
          ...
          <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-8">
             ...
             <ul className="space-y-3">
               {['Cybersecurity (HIPAA, HITRUST)', 'Data Interoperability (TEFCA)', 'Patient Consent Management'].map(item => (
