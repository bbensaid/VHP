...
| — `next/no-img-element` | lint | **13** | **6** (Cycles 12–13,16: 7 → next/image; remaining 6 = book SVG + 4 subscribe placeholders + 1 webinar fallback, all correct deferrals) | documented-exempt |
