...
The central analytical contribution of this book is the six-pillar framework for healthcare transformation: Policy, Technology, Economics, Clinical, Equity, and Operations. It is not a checklist of things that should be done, but an integrated architecture for understanding why transformation attempts fail when they address any pillar in isolation. Remove any one pillar and the transformation fails: payment reform without the data infrastructure to manage it, or the clinical models to respond to it, produces financial pressure without improvement.
...
*Figure 1.2 — The six pillars: diagnostic questions and structural roles. Sources: six-pillar framework documentation; Acts 167 and 68 of 2025.*
...
*Figure 1.3 — The architecture of interdependency: the fifteen dependency relationships, read From-row to To-column. Sources: six-pillar framework documentation; Vermont Health Transformation / HTR (2026).*
...
::: {custom-style="StatStrip"}
**6** — Pillars, All Required

**15** — Dependency Relationships

**6** — Failure Cascade Patterns
...
+==================================+========================================================+
| **Layer 1** — VHCURES (All-Payer | Foundation for total-cost-of-care measurement and      |
| Claims Database)                 | HEDIS stratification. Gap: race/ethnicity data         |
|                                  | incomplete in commercial claims.                       |
+----------------------------------+--------------------------------------------------------+
| **Layer 2** — VITL / VHIE        | Clinical data substrate — diagnoses, labs,             |
| (Health Information Exchange)    | medications, care plans. Voluntary participation means |
|                                  | not all providers are connected.                       |
+----------------------------------+--------------------------------------------------------+
| **Layer 3** — AHS-GMCB Analytics | Modeling layer for global budget design, TCOC          |
| Vendor (procurement underway)    | tracking, risk stratification, and equity monitoring.  |
|                                  | AHEAD launches January 2028.                           |
+----------------------------------+--------------------------------------------------------+
...
| Layer                        | Components                                                   |
+==============================+==============================================================+
| **Layer 5 (Top)** — Advanced | - Population health analytics platform (joint AHS-GMCB       |
| Analytics & AI Applications  |   vendor): models transformation scenarios, evaluates        |
|                              |   hospital proposals, tracks outcome metrics                 |
|                              | - AI scribe & documentation automation: RHT grants; CIN      |
|                              |   enterprise contract                                        |
|                              | - Diagnostic AI: network-wide deployment via CIN shared      |
|                              |   services with shared AI governance                         |
|                              | - Remote patient monitoring: RPM for CHF, COPD, diabetes;    |
|                              |   community paramedicine integration                         |
|                              | - Price transparency dashboard: GMCB public tool;            |
|                              |   patient-facing comparison via RHT                          |
+------------------------------+--------------------------------------------------------------+
| **Layer 4** — Population     | - Blueprint clinical data registry: HEDIS measurement,       |
| Health Management            |   care-gap reporting, population risk stratification         |
|                              | - Attribution management: patient-to-hospital attribution    |
|                              |   for AHEAD global budgets; PC AHEAD attribution             |
|                              | - SDOH screening data: Blueprint HRSN results linked to      |
|                              |   health records                                             |
|                              | - Care coordination registry: CHT patient registries; CCBHC  |
|                              |   care-management data                                       |
+------------------------------+--------------------------------------------------------------+
| **Layer 3** — Integrated     | - VHCURES–VHIE integration: claims merged with clinical data |
| Health Record (Target State) |   per HIE Steering Committee mandate                         |
|                              | - Mental health & SUD data integration: 42 CFR Part 2        |
|                              |   compliant consent; CCBHC and DA data                       |
|                              | - SDOH data integration: social-service utilization linked   |
|                              |   to the health record with privacy protections              |
|                              | - Single patient identity: master patient index across all   |
|                              |   14 hospitals and community providers                       |
+------------------------------+--------------------------------------------------------------+
| **Layer 2** — Data Exchange  | - Vermont Health Information Exchange (VHIE/VITL): clinical  |
| Infrastructure               |   data exchange; connectivity mandated by Act 68             |
|                              | - FHIR R4 APIs: CMS-mandated payer and provider APIs;        |
|                              |   expanding to community providers via RHT grants            |
|                              | - Vermont Clinically Integrated Network: shared data         |
|                              |   standards, protocols, exchange agreements across 14        |
|                              |   hospitals                                                  |
|                              | - CommonWell / Carequality: national network connectivity    |
|                              |   for out-of-state care records                              |
+------------------------------+--------------------------------------------------------------+
| **Layer 1 (Foundation)** —   | - VHCURES (all-payer claims database): 100%                  |
| Core Data Assets             |   Medicaid/Medicare; 60% commercial; GMCB-managed; Onpoint   |
|                              |   vendor                                                     |
|                              | - VUHDDS (hospital discharge database): all 14 hospitals;    |
|                              |   all inpatient, outpatient, ED discharges                   |
|                              | - EHR systems at 14 hospitals: Epic (UVMMC), Oracle Health   |
|                              |   (CVMC, others), TruBridge (CAHs), Meditech (others)        |
|                              | - Blueprint clinical registry: quality-measure data linked   |
|                              |   to VHCURES for population-level HEDIS                      |
|                              | - GMCB regulatory data: hospital budgets, rate filings, CON  |
...
::: {custom-style="StatStrip"}
**Jan 2028** — AHEAD Cohort 2 Launches

**$150M/yr** — EAST Fund for Vermont

**9 Years** — Model Duration to 2035

**3-Payer** — Medicare + Medicaid + Commercial
:::
...
*Figure 11.9 — Attribution error taxonomy and remediation. Sources: HTR's Operations pillar framework; ACO REACH and MSSP operational guidance.*
...
Sources: Vermont AHEAD State Agreement (January 17, 2025); CMMI AHEAD Model documentation; AHS January 2025 Legislative Presentation.
...
## **Stage 5 — Equity: Calibrate for the Gap, Not the Average**
...
## **Stage 6 — Operations: Close the Execution Gap**
