...
Vermont's answer, enacted in Acts 167, 51, and 68 and partially funded by the federal government, is the subject of this book. Whether it constitutes successful transformation will be determined over the next five to ten years. What is already clear is that Vermont has committed to structural change with more specificity, more statutory force, and more capital investment than any comparably sized system in recent American health policy history.
...
Few words in healthcare are used more often than "reform" or "transformation," and the frequency has cost them precision. Both get applied to routine process improvements and to genuine structural change alike, and to aspiration as readily as to commitment — which makes it worth stating, at the outset, exactly what this book means.
